 ...
 *  CCHTML 1.3.1 by @colorclass - http://colorclass.ir
...
function cc_fSetObjectTextRBGA(cc_vElement, cc_vTColor, cc_vTOpacity){
	if(cc_vTColor.length == 4){
		...
		if (0) { //IE8- ... if (cc_vElement.currentStyle) { //IE ...
	        	;// cc_vElement.currentStyle["color"]
			//cc_vElement.currentStyle["background-color"]
