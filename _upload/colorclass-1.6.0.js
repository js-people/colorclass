 ...
 *  CCHTML 1.6.0 by @colorclass - http://colorclass.ir
 ...
 *
 * This revision (v 1.6.0):
 *  26-- Improve, Background image class in chrome
 *  27-- Filter, Background images Gray Scale filter i#[xx]=[xx] or i#[x]=[x] (Example: i#20=80 , i%2= [or i%20=100] )
...
function cc_fSetBGOpacity(cc_vElement, cc_vBGImage, cc_vString){
	...
	var cc_vBGI2 = cc_fGetHoverValue(cc_vBGIGS, 0);



        cc_vBGI2[0] = (parseFloat(cc_vBGI2[0])*100).toString(10);

        cc_vBGI2[1] = (parseFloat(cc_vBGI2[1])*100).toString(10);
...

        {
...

	        {
	                ...
	                cc_vElement.addEventListener("mouseenter", function(){
                                ...
                                cc_vElement.style.filter = "grayscale(" + cc_vBGI2[1] + "%)";
	                ...
	                cc_vElement.addEventListener("mouseleave", function(){
                                ...
                                cc_vElement.style.filter = "grayscale(" + cc_vBGI2[0] + "%)";
		...
		var cc_vAddedElement2 = document.createElement("div");
	        ...
	        cc_vString = cc_fClearCommands(cc_vString);
                ...
                cc_vBGImage = cc_vBGImage.replace("=0.", "=");

                cc_vBGImage = cc_vBGImage.replace("0.", " i%");

                cc_vBGIGS = cc_vBGIGS.replace("=0.", "=");

                cc_vBGIGS = cc_vBGIGS.replace("0.", " i#");
		...
		cc_vElement.setAttribute("style", "");
...

	        {
	                ...
	                cc_vAddedElement2.addEventListener("mouseenter", function(){
                        	...
                        	cc_vAddedElement1.style.filter = "grayscale(" + cc_vBGI2[1] + "%)";
	                ...
	                cc_vAddedElement2.addEventListener("mouseleave", function(){
                        	...
                        	cc_vAddedElement1.style.filter = "grayscale(" + cc_vBGI2[0] + "%)";
